...
?>
	...
	<section>
		...
		First Name:
		<br><input type="text" id="firstname" name="firstname" placeholder="firstname" value="<?php include 'session.php'; echo $firstname;?>" autofocus ="autofocus"><span class="error">* <?php echo $firstnameErr;?></span><br><hr>
		Lastname:
