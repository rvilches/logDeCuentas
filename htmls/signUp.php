...
?>
	...
	<section>
		...
		Username:
		<br><input type="text" name="username" placeholder="username" value="<?php echo $_POST['username'];?>"><span class="error">* <?php include 'session.php'; echo $usernameErr;?></span><br><hr>
		Password:
